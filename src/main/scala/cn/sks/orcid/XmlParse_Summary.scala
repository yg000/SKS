...
/*
  ...
  works(成果)
*/
object XmlParse_Summary {
  def main(args: Array[String]): Unit = {
    val spark = SparkSession.builder()
      .master("local[*]")
      .appName("XmlParse_Summary")
...
//    val xmlpath="/data/ORCIDTEST/0/000/0000-0001-5881-6000/employments/0000-0001-5881-6000_employments_807958`.`xml"
    ...
    val folder="5"
    val xmlpath="/data/ORCID/summaries/"+folder+"*/*.xml"
...
//      """.stripMargin)
//
//    sql11.repartition(10).write.format("hive").mode("overwrite")
//      .insertInto("test_orcid.summary_"+folder)
