...
CREATE TABLE if not exists dwb.`wb_product_journal_ms_csai_nsfc_rel`(
...
CREATE TABLE if not exists dwb.`wb_product_journal_ms_csai_nsfc_orcid_rel`(
  `achievement_id_orcid` string, 
  `achievement_id_ms_csai_nsfc` string,
  `product_type` string,
  `source` string
  )
row format delimited fields terminated by '☔' stored as orc;
...
CREATE TABLE if not exists dwb.`wb_product_journal_ms_csai_nsfc`(
  `achievement_id` string, 
  `paper_type` string, 
  `chinese_title` string, 
  `english_title` string, 
...
CREATE TABLE if not exists dwb.`wb_product_journal_ms_csai_nsfc_orcid`(
  `achievement_id` string, 
  `paper_type` string, 
  `chinese_title` string, 
  `english_title` string, 
...
CREATE TABLE if not exists dwb.`wb_product_patent_ms_csai_nsfc_rel`(
  `achievement_id_csai` string, 
  `achievement_id_nsfc` string,
  `product_type` string,
  `source` string)
...
CREATE TABLE dwb.`wb_product_patent_ms_csai_nsfc`(
  `achievement_id` string, 
  `chinese_title` string, 
  `englisth_title` string, 
  `abstract` string, 
...
row format delimited fields terminated by '☔' stored as orc;
CREATE TABLE if not exists dwb.`wb_product_monograph_ms_csai_nsfc_rel`(
  `achievement_id_csai` string, 
  `achievement_id_nsfc` string,
  `product_type` string,
  `source` string
...
CREATE TABLE dwb.`wb_product_monograph_csai_nsfc`(
  ...
  CREATE TABLE dwb.`wb_product_monograph_ms_csai_nsfc`(
  `achievement_id` string, 
  `chinese_title` string, 
  `english_title` string, 
  `author` string, 
